...
public static class OctahedronSphereCreator {
    ...
    private static void CreateUV (Vector3[] vertices, Vector2[] uv) {
        ...
        for (int i = 0; i < vertices.Length; i++) {
            ...
            textureCoordinates.x = 1-Mathf.Atan2(v.x, v.z) / (-2f * Mathf.PI);
        ...
        uv[vertices.Length - 1].x = uv[3].x = 0.125f;
        uv[vertices.Length - 2].x = uv[2].x = 0.375f;
        uv[vertices.Length - 3].x = uv[1].x = 0.625f;
        uv[vertices.Length - 4].x = uv[0].x = 0.875f;
    }
